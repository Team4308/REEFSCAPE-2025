...
public class L3Algae2 extends Command {
    ...
    public L3Algae2(ElevatorSubsystem elevatorSubsystem, CoralRollerSubsystem rollerSubsystem,
    ...
    public void initialize() {
        if (m_elevatorSubsystem.isAtPosition2("A2P")) {
            stage2().schedule();
        } else {
            stage1().schedule();
        }
    ...
    private Command stage2() {
        return new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        new SimpleElevator(() -> constElevator.ALGAE2_PREMOVE + 2 * constElevator.ALGAE_DISTANCE,
                                m_elevatorSubsystem),
                ...
                new SimpleElevator(() -> constElevator.L1 + Units.inchesToMeters(12), m_elevatorSubsystem),
